...
export function createPostApplicationGraph(services: RagGraphServices) {
  ...
  function routeAfterMissingInfo(
    state: PostApplicationGraphState,
  ): 'collect_post_application_context' | 'save_message' {
    return state.answer ? 'save_message' : 'collect_post_application_context';
  }
